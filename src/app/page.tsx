      ...
      <main className="relative z-10 px-6 pt-24 pb-12 flex flex-col items-center min-h-[100dvh]">
        ...
        >
          <div className="text-xl font-bold tracking-tight flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl overflow-hidden relative shadow-[0_0_15px_rgba(0,255,255,0.3)]">
              <img src="/icon.png" alt="OnCampus Icon" className="w-full h-full object-contain" />
            </div>
