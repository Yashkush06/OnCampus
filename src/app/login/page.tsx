  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[100dvh] bg-bg-dark relative overflow-hidden px-6">
      ...
      >
        ...
        <p className="text-white/60 mb-10 text-center">Verify your student status to join the scene.</p>
        ...
        <div className="w-full space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Link href="/feed" className="block w-full">
              <button className="w-full py-4 rounded-xl bg-[var(--color-neon-blue)] text-black font-bold text-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity glow-blue">
                Send Magic Link
                <ArrowRight size={20} />
              </button>
            </Link>
